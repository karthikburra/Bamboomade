...
const SocialMediaCarousel: React.FC = () => {
  // Add Instagram script processing
  useEffect(() => {
      ...
      <CardContent className="pt-4 px-4 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="h-full">
            <SocialMediaEmbed 
              platform="youtube"
              embedCode={`<iframe width="100%" height="315" src="https://www.youtube.com/embed/ypickt7W1nw?si=VNgiI30p8tlCNI4d" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`}
              title="Bamboo Construction Techniques"
              description="Learn about innovative bamboo construction methods in this comprehensive video guide for sustainable architecture."
              link="https://www.youtube.com/embed/ypickt7W1nw?si=VNgiI30p8tlCNI4d"
            />
          </div>
          ...
          <div className="h-full">
            <SocialMediaEmbed 
              platform="linkedin"
              embedCode={`<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7323319829271064579" height="570" width="100%" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>`}
              title="Industry Insights on Bamboo"
