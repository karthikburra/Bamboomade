            ...
            {navLinks.map((link) => (
              ...
              >
                <span className="relative flex items-center">
                  {link.icon && <link.icon className="mr-1.5 h-[0.9em] w-[0.9em] sm:h-[1em] sm:w-[1em] md:h-[1.1em] md:w-[1.1em]" />}
                  {link.label}
                  {link.isNew && (
              ...
              <SheetContent className="w-[85%] sm:max-w-sm px-4 sm:px-6 bg-gray-900 border-l border-green-800/50 text-white">
                ...
                <nav className="flex flex-col space-y-3 sm:space-y-4 mt-5 sm:mt-6 md:mt-7">
                  {navLinks.map((link) => (
                    ...
                    >
                      <span className="relative flex items-center">
                        {link.icon && <link.icon className="mr-2 h-[1em] w-[1em] sm:h-[1.1em] sm:w-[1.1em] md:h-[1.2em] md:w-[1.2em]" />}
                        {link.label}
                        {link.isNew && (
                  ...
                  {user && (
                    <div className="pt-3 sm:pt-4 mt-1 sm:mt-2 border-t border-green-800/50 space-y-3">
                      ...
                      >
                        <MessageSquareText className="mr-2 h-[1em] w-[1em] sm:h-[1.1em] sm:w-[1.1em] md:h-[1.2em] md:w-[1.2em]" />
                        View My Sessions
                      </ScrollLink>
