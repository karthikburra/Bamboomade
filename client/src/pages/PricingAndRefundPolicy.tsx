  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-3xl font-bold mb-6 text-green-500">Pricing & Refund Policy</h1>
        <p className="text-gray-400 mb-8">
          Last updated: May 3, 2025
        </p>
        
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-green-400">Project Guidance Services</h2>
          <Separator className="mb-6 bg-green-900" />
          
          <h3 className="text-xl font-medium mb-3 text-green-300">Pricing Structure</h3>
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-900 p-6 rounded-lg border border-green-800">
              <h4 className="text-lg font-medium mb-2 text-green-300">Student Rates</h4>
              <p className="text-3xl font-bold mb-4">₹2,505 <span className="text-lg font-normal text-gray-400">per hour</span></p>
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-green-800">
              <h4 className="text-lg font-medium mb-2 text-green-300">Professional Rates</h4>
              <p className="text-3xl font-bold mb-4">₹5,000 <span className="text-lg font-normal text-gray-400">per hour</span></p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span>One-on-one guidance via Google Meet</span>
          ...
          <div className="mb-10">
            <h3 className="text-xl font-medium mb-3 text-green-300">Session Duration Options</h3>
            <p className="mb-4 text-gray-300">
              We offer flexible session durations to accommodate different project needs:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-gray-900 p-4 rounded-lg border border-green-800 text-center">
                <p className="font-medium text-green-400 mb-1">30 minutes</p>
                <p className="text-sm text-gray-400">Quick consultation</p>
              </div>
              <div className="bg-gray-900 p-4 rounded-lg border border-green-800 text-center">
                <p className="font-medium text-green-400 mb-1">60 minutes</p>
                <p className="text-sm text-gray-400">Standard session</p>
              </div>
              <div className="bg-gray-900 p-4 rounded-lg border border-green-800 text-center">
                <p className="font-medium text-green-400 mb-1">90 minutes</p>
                <p className="text-sm text-gray-400">Extended guidance</p>
              </div>
              <div className="bg-gray-900 p-4 rounded-lg border border-green-800 text-center">
                <p className="font-medium text-green-400 mb-1">120 minutes</p>
                <p className="text-sm text-gray-400">Comprehensive support</p>
              </div>
            </div>
          ...
          <div className="mb-10">
            <h3 className="text-xl font-medium mb-3 text-green-300">Payment Process</h3>
            <p className="mb-4 text-gray-300">
            ...
            <div className="bg-gray-900 p-5 rounded-lg border border-green-800 mb-4">
              <h4 className="font-medium text-green-300 mb-2">Payment Steps:</h4>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-green-400">Refund Policy</h2>
          <Separator className="mb-6 bg-green-900" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg border border-green-800 mb-8">
            <h3 className="text-xl font-medium mb-3 text-green-300">Cancellation Terms</h3>
          ...
          <div className="mb-8">
            <h3 className="text-xl font-medium mb-3 text-green-300">Rescheduling Option</h3>
            <p className="mb-4 text-gray-300">
          ...
          <div className="mb-8">
            <h3 className="text-xl font-medium mb-3 text-green-300">How to Request a Refund</h3>
            <p className="mb-4 text-gray-300">
            ...
            <div className="bg-gray-900 p-5 rounded-lg border border-green-800">
              <p className="text-gray-300 mb-2">
                <span className="font-medium text-green-400">Email:</span> projects@bamboomade.in
              </p>
              <p className="text-gray-300">
                <span className="font-medium text-green-400">WhatsApp:</span> +91 8971690163
              </p>
            </div>
          </div>
          
          <div>
            <h3 className="text-xl font-medium mb-3 text-green-300">Technical Issues</h3>
            <p className="text-gray-300">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-4 text-green-400">Additional Terms</h2>
          <Separator className="mb-6 bg-green-900" />
