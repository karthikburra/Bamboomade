          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-gray-400 text-center">
                Please log in with an admin account to manage knowledge content
              </p>
              <div className="flex flex-col gap-2">
                <Link href="/dev-admin-login">
...
export default function AddKnowledge() {
  ...
  return (
    <AdminCheck>
      <>
        <Navbar />
        <main className="min-h-screen bg-gray-950 text-white pt-16 pb-12">
          <div className="container max-w-3xl mx-auto px-4 py-8">
            <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-amber-500 mb-1">Add Knowledge Content</h1>
                <p className="text-gray-400">
                  Contribute to the bamboo knowledge database
                </p>
              </div>
              <div className="flex gap-2">
                <Link href="/ai-knowledge-database">
